-- Live Fusion Pipeline with Kalman Filter Output
-- Streams real-time sensor fusion results
...
procedure Live_Fusion_Pipeline is
   ...
   begin
      ...
      DT := Float (To_Duration (Clock - State.Last_Update));
      State.Last_Update := Clock;
      ...
      if DT > 0.0 and DT < 0.2 then
         ...
         begin
            ...
            declare
               Q_Mag : constant Float := 
                 State.Q_X**2 + State.Q_Y**2 + State.Q_Z**2 + State.Q_W**2;
            begin
               if Q_Mag > 0.01 then
   ...
   begin
      ...
      if Last > Buffer'First then
         ...
         begin
            ...
            Put_Line ("[" & Image (Clock) & "] Received " & Natural'Image (Natural (Last)) & 
            ...
            begin
               if JSON_Body'Length > 0 then
                  ...
                  if Current_Accel.Valid or Current_Gyro.Valid then
                     ...
                     Put_Line ("Timestamp: " & Image (Clock));
                     Put_Line ("Quaternion: [" & 
...
begin
   Put_Line ("=== Live Fusion Pipeline with Kalman Filter ===");
